...
class _PatientsScreenState extends State<PatientsScreen> {
  ...
  void _refreshPatients(){if(!mounted)return;setState((){_reload();});}
  ...
  Future<void> _addPatient() async {
    ...
    try {
      ...
      if(!mounted)return;
      if(saved==null){ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content:Text('Não foi possível recuperar o paciente cadastrado. Tente novamente.')));_refreshPatients();return;}
      _refreshPatients();
